...
const Farms = () => {
  ...
  const description = [
    'Kafr Dawood Farm spans 160 feddans, where diverse crops thrive, supported by modern agricultural practices and high-yield production. The farm’s standout features include 45 feddans of premium grapes, 35 feddans of advanced greenhouses, and expansive strawberry fields.Each season, Kafr Dawood produces:400 tons of high-quality grapes, featuring varieties such as Prime, Sugarcane, Starlight, Black Glory, and Midnight Beauty, harvested between May and July.500 tons of strawberries, grown across 25 feddans, ensuring sweet and fresh produce.300 tons of beans and peppers, cultivated in cutting-edge greenhouses.500 tons of onions, grown in protected environments for consistent quality.60 tons of premium sugar peas and mangetout, prized for their freshness and flavor.',
