...
import aboutImage from '../assets/backgrounds/photo_2024-12-11_23-48-19.jpg';
import smallImage from '../assets/images/IMG-20241202-WA0045.jpg';
  ...
  >
    <div className="flex-1 bg-black bg-opacity-30 backdrop-blur-lg py-14 lg:py-20 px-8 rounded-lg shadow-lg">
      ...
      <p className="text-[] lg:text-xl leading-relaxed text-gray-300">
        With over 30 years of expertise, Nivex has established itself as a leader in providing certified agricultural products to Europe.
      </p>
    </div>
