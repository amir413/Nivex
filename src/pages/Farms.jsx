...
const Farms = () => {
  ...
  const description = [
    'Kafr Dawood Farm spans 160 feddans, producing high-quality crops with modern agricultural methods. Key highlights include:45 feddans of grapes: 400 tons annually, featuring varieties like Prime, Sugarcane, and Midnight Beauty (May–July).25 feddans of strawberries: 500 tons annually.35 feddans of greenhouses: 300 tons of beans and peppers.15 feddans of onions: 500 tons annually.10 feddans of sugar peas and mangetout: 60 tons annually.Kafr Dawood combines innovation and tradition to deliver outstanding yields each season.',
